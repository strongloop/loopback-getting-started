...
Thank you for your interest in `loopback-getting-started`, an open source project
administered by StrongLoop.

Contributing to `loopback-getting-started` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/strongloop/loopback-getting-started)
